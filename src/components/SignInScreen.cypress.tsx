...
describe('SignInScreen', () => {
  ...
  let onSignIn: SignInScreenProps['onSignIn']
  let onCompanyCodeSubmit: SignInScreenProps['onCompanyCodeSubmit']

  beforeEach(() => {
    onSignIn = cy.stub().as('onSignIn')
    onCompanyCodeSubmit = cy.stub().as('onCompanyCodeSubmit')
  })
